...
static bool g_FirstPersonModelEnabled = true;
...
// Hook for camera rendering to render player model in first person
...
static void DrawMenu() {
    ...
    ImGui::Begin("FirstPersonModel", &g_ShowMenu, ImGuiWindowFlags_NoResize);
    
    ImGui::Checkbox("Enable First Person Model", &g_FirstPersonModelEnabled);
    
    ImGui::Separator();
    ImGui::Text("Camera Offset:");
    ImGui::SliderFloat("X Offset", &g_CameraOffsetX, -2.0f, 2.0f);
    ImGui::SliderFloat("Y Offset", &g_CameraOffsetY, -2.0f, 2.0f);
    ImGui::SliderFloat("Z Offset", &g_CameraOffsetZ, -2.0f, 2.0f);
    
    ImGui::Separator();
    ImGui::SliderFloat("Model Scale", &g_ModelScale, 0.5f, 2.0f);
    
    if (ImGui::Button("Reset Defaults")) {
        g_CameraOffsetX = 0.0f;
        g_CameraOffsetY = -0.2f;
        g_CameraOffsetZ = 0.5f;
        g_ModelScale = 1.0f;
    }
...
static void InitCameraAPI() {
    ...
    // Camera position/rotation functions
